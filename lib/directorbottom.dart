...
import 'package:katheriniesorwutever/hourcounter.dart';
import 'package:katheriniesorwutever/hourcounterall.dart';
...
import 'CoDirectorAttendance.dart';
...
class _directorNavigationState extends State<directorNavigation> {
  ...
  void initState(){
    ...
    _widgetoption = [ attends(title: 'Confirm'), hours(title: 'Hour Counter'),HomePage(title: 'Doordash'),profile(title: 'title'),Feedbacks(title: 'title')];
    setState(() {
